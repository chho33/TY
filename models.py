...
class YOLOLayer(nn.Module):
    ...
    def forward(self, p, img_size, targets=None, var=None):
        ...
        print('bs, self.nA, self.nC, nG, nG: ',bs, self.nA, self.nC, nG, nG)
        print('all: ',bs*self.nA*self.nC*nG*nG)
        p = p.view(bs, self.nA, self.nC, nG, nG).permute(0, 1, 3, 4, 2).contiguous()  # prediction
        ...
        for i, (module_def, module) in enumerate(zip(self.module_defs, self.module_list)):
            ...
            if mtype in ['convolutional', 'upsample', 'maxpool']:
                ...
                if len(layer_i) == 1:
                    ...
                    print('layer_outputs: ',len(layer_outputs),layer_outputs[0].shape,layer_outputs[1].shape,layer_outputs[-1].shape)
